...
export default class Photo extends React.Component {
  ...
  toggleSelection = () => {
    this.setState({ selected: !this.state.selected }, () => this.props.onSelectionToggle(this.props.uri, this.state.selected));
  };

  detectFace = () => FaceDetector.detectFacesAsync(this.props.uri, {
